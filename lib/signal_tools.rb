...
#      initialize(ticker, from_date, to_date)
#      @average_true_range_cache[cache_symbol(ticker, from_date, to_date, days)] ||= AverageTrueRange.new(ticker, days, @historical_data)
#    end

#    def average_directional_index(ticker, from_date, to_date, days=14)
#      initialize(ticker, from_date, to_date)
#      @average_directional_index_cache[cache_symbol(ticker, from_date, to_date, days)] ||= AverageDirectionalIndex.new(ticker, days, @historical_data)
#    end
